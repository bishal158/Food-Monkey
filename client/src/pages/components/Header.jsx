                    ...
                    <div className="header-container">
                        ...
                        {email && (
                            <div className={"user-info"}>
                                ...
                                <NavLink to={"/login"} onClick={logout} className={"user-info-content logout-tool"}>
                            ...
                            {email  && (
                                <>
                                    ...
                                    {isAdmin
                                        ?
                                        <>
                                            <NavLink to={"/add-products"} className={"user-info-content-modal"}>
                                                <FontAwesomeIcon icon="fa-solid fa-plus" /> Add Product
                                            </NavLink>
                                            <NavLink to={"/view-orders"} className={"user-info-content-modal"}>
                                                <FontAwesomeIcon icon="fa-solid fa-cart-shopping" /> View Orders
                                            </NavLink>
                                        </>
                                        :
                                        <>
                                    ...
                                    <NavLink to={"/"} onClick={logout} className={"user-info-content-modal"}>
